...
class MemberService{
	...
	//매개변수로 클래스변수배열을 받아서 출력하는 형태로 작성
...
public class Step2 {
	...
	public static void main(String[] args) {
		...
		//setter 메서드를 이용해 해당 인스턴스 변수에 값을 넣어준다.
		m1.setName("홍길동");
		m1.setAge(45);
		m1.setPhoneNum("000-0000-0000");
		//마찬가지로 다른 MemberVO객체(instance)를 생성해서
		...
		//크기가 3인 MemverVO클래스를 배열객체로 선언
		MemberVO[] members = new MemberVO[3];//[0],[1],[2]
